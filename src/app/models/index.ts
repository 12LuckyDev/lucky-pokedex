...
export * from './app-logic/pokedex-ui-settings.model';
export * from './app-logic/specyfic-selection.model';

export * from './app-logic/statisticts/selection-statistics.model';
export * from './app-logic/statisticts/entry-for-statistics.model';
export * from './app-logic/statisticts/statistics-observables.model';

export * from './pokedex-data/pokedex-entry.model';
